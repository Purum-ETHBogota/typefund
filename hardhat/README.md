...
This project was bootstrapped using the [FEVM Hardhat Kit](https://github.com/filecoin-project/fevm-hardhat-kit).
...
The 2 main contracts `TypeFundDAO.sol` and `TypeFundMarket.sol` will be deployed to Hyperspace testnet
...
Currently you will find a getter contract that calls the getter methods on the MarketAPI to get storage deal data and store that data. To do this you will need _dealIDs_ which you can [find here on FilFox](https://hyperspace.filfox.info/en/deal).
