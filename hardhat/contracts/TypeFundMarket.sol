...
//Hyperspace
//Oracle Address: 0xd466a3c66ad402aa296ab7544bce90bbe298f6a0
...
contract OnlyFiles is IEncryptionClient, PullPayment {
    ...
    function oracleResult(uint256 requestId, Ciphertext calldata cipher) override external onlyOracle {
